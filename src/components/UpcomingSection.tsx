...
export function UpcomingSection() {
  ...
  return (
    <section className="w-full bg-graphite px-6 py-24 text-paper md:px-12 md:py-36">
        ...
        <div className="border-t border-paper/30">
          {projects.map((p, i) => (
            <motion.div
              ...
              className="grid grid-cols-12 items-baseline gap-4 border-b border-paper/30 py-7 md:py-9"
            >
              <span className="meta col-span-12 text-paper/65 md:col-span-3">
                {p.status}
              </span>
              <span className="display col-span-12 text-3xl uppercase md:col-span-6 md:text-4xl">
                {p.title}
              </span>
              <span className="meta col-span-12 text-paper/65 md:col-span-3 md:text-right">
                {p.collaborator}
              </span>
            </motion.div>
          ))}
        ...
        <div className="mt-20 md:mt-28">
          ...
          <AnimatePresence initial={false}>
            {showAbout && (
              ...
              >
                <div className="mt-12 grid grid-cols-1 gap-12 border-t border-paper/30 pt-12 md:grid-cols-12">
                  <div className="md:col-span-4">
                    ...
                    <dl className="mt-10 space-y-3">
                      <div className="flex justify-between border-b border-paper/25 pb-2">
                        <dt className="meta text-paper/65">Education</dt>
                        <dd className="text-xs">BBA, Business Analytics</dd>
                      </div>
                      <div className="flex justify-between border-b border-paper/25 pb-2">
                        <dt className="meta text-paper/65">Company</dt>
                  ...
                  <div className="md:col-span-7 md:col-start-6">
                    <span className="meta text-paper/70">Professional Focus</span>
                    ...
                    <span className="meta mt-14 block border-b border-paper/30 pb-3 text-paper/70">
                      Technical Arsenal
                    </span>
                    <div className="mt-6 flex flex-wrap gap-x-6 gap-y-3">
                      {skills.map((s) => (
                        <span key={s} className="meta text-paper/85">
                          {s}
                        </span>
                      ))}
                    </div>
